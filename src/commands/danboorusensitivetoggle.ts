...
export default {
    data: new SlashCommandBuilder()
        ...
        .setDescription("Allows/disallows /danbooru to return posts with rating:sensitive when used in a non-NSFW channel"),
    async execute(interaction: CommandInteraction) {
        ...
        try {
            ...
            if (Array.isArray(general.whitelist)) {
        ...
        try {
            ...
            winston.error("Error trying to write ./storage/general.json")
                .error(e);
        }
    }
}
